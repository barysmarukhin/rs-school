    ...
    drawPacman(x, y, radiusDivisor, direction, color = '#000', framesPerMovement = 30) {
        ...
        if (direction == 'stopped') {
            if (this.get('movesCache') === null) {
                pacmanImage.src = "/assets/graphic-models/pacman-right.svg";
            } else {
        ...
        if (direction == 'left') {
            pacmanImage.src = "/assets/graphic-models/pacman-left.svg";
            this.set('movesCache', pacmanImage.src);
        }

        if (direction == 'down') {
            pacmanImage.src = "/assets/graphic-models/pacman-down-right.svg";
            this.set('movesCache', pacmanImage.src);
        }

        if (direction == 'up') {
            pacmanImage.src = "/assets/graphic-models/pacman-up-left.svg";
            this.set('movesCache', pacmanImage.src);
        }
