...
function autocomplete(input, latInput, lngInput) {
  if (!input) return; //return if there is no input
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 53.9;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 27.6;

  _axios2.default.get('/administrator/api/events/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    var places = res.data;
    if (!places.length) {
    ...
    markers.forEach(function (marker) {
      return marker.addListener('click', function () {
        var html = '\n          <div class="popup">\n            <a href="/administrator/event/' + this.place.slug + '">\n              <img src="/uploads/' + (this.place.photo || 'event.png') + '" alt="' + this.place.name + '" />\n              <p>' + this.place.name + ' - ' + this.place.location.address + '</p>\n            </a>\n          </div>\n        ';
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/administrator/api/search?q=' + this.value).then(function (res) {
      if (res.data.length) {
...
function typeSpeakers(search, addButton) {
  ...
  addButton.on('click', function () {
    ...
    var newSpeakerHTML = '<span class="search-speakers__remove">x</span><input id="search-speaker" type="text" autocomplete="off" type="text" placeholder="Search speaker..." class="search-speakers__input"><div class="search-speakers__results"></div><input type="hidden" name="speakers" class="search-speakers__input-hidden">';
  ...
  search.on('click', function (e) {
    if (e.target.classList.contains('search-speakers__result-text')) {
      ...
      var currentRemoveButton = e.target;
      var currentSpeakerField = currentRemoveButton.parentNode;
...
var _typeSpeakers = __webpack_require__(14);

var _typeSpeakers2 = _interopRequireDefault(_typeSpeakers);
